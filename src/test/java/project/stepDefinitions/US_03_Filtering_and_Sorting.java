...
//    }
    ...
    public void userClicksOnDestinationHomePage() {
      filterandSortingPage.destinationayca.sendKeys("USA");
    ...
    public void userClicksSearchButton() {
        filterandSortingPage.destinationayca.sendKeys(Keys.TAB,Keys.TAB,Keys.TAB);
        filterandSortingPage.searchButtonayca.click();
    }
